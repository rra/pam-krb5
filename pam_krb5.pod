...
example, "B<mappings = ^EXAMPLE\\(.*)$ $1@EXAMPLE.COM>" would map any
user with a name of the form "EXAMPLE\whatever" to a principal name of
"whatever@EXAMPLE.COM".  This is primarily targeted at allowing pam_krb5
...
[3.0] Require PKINIT authentication.  You will probably also need to set
the I<pkinit_user> configuration option.  If PKINIT fails, authentication
